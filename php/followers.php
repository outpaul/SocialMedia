...
$query = "SELECT socialMedia.* FROM accFol,socialMedia WHERE accFol.accId=socialMedia.accId AND accFol.folId=fetchId('$userId','$site')";
...
<body align="center">
	...
	<?php 
		if($result->num_rows > 0) {
			...
			echo "<h2>You have no followers in this account.</h2>";
		} ?>
